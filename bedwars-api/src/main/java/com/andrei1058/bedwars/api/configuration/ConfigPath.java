...
public class ConfigPath {
    ...
    public static final String GENERAL_CONFIGURATION_INVIS_FOOTSTEPS_ENABLED = GENERAL_CONFIGURATION_INVIS_FOOTSTEPS+".footsteps-enabled";
    ...
    public static final String GENERAL_CONFIGURATION_ENABLE_SPONGE_EFFECT = "enable-sponge-effect";

package com.andrei1058.bedwars.shop.config;

import com.andrei1058.bedwars.BedWars;
import com.andrei1058.bedwars.api.configuration.ConfigManager;
import com.andrei1058.bedwars.api.configuration.ConfigPath;
import com.andrei1058.bedwars.api.language.Messages;
import com.andrei1058.bedwars.api.shop.IShopManager;
...
public class Shop3v3v3v3Config extends ConfigManager implements IShopManager {

    public static ShopIndex shop;

    public Shop3v3v3v3Config() {
        super(BedWars.plugin, "3v3v3v3-shop", BedWars.plugin.getDataFolder().getPath() + "/Shops");
        saveDefaults();
    }
    ...
    private void saveDefaults() {
        ...
        if (isFirstTime()) {
            ...
            addCategoryContentTier(ConfigPath.SHOP_PATH_CATEGORY_MELEE, "diamond-sword", 21, "tier1",
                    BedWars.getForCurrentVersion("DIAMOND_SWORD", "DIAMOND_SWORD", "DIAMOND_SWORD"), 0, 1, false, 3, "emerald", false, false, true);
            ...
            addCategoryContentTier(ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "tnt", 23, "tier1",
                    BedWars.getForCurrentVersion("TNT", "TNT", "TNT"), 0, 1, false, 8, "gold", false, false);
            ...
            addCategoryContentTier(ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "water-bucket", 25, "tier1",
                    BedWars.getForCurrentVersion("WATER_BUCKET", "WATER_BUCKET", "WATER_BUCKET"), 0, 1, false, 6, "gold", false, false);
            ...
            addCategoryContentTier(ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "sponge", 30, "tier1",
                    BedWars.getForCurrentVersion("SPONGE", "SPONGE", "SPONGE"), 0, 4, false, 6, "gold", false, false);

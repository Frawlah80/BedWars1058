...
public class MainConfig extends ConfigManager {
    ...
    public MainConfig(Plugin plugin, String name) {
        ...
        yml.addDefault(ConfigPath.SB_CONFIG_SIDEBAR_LIST_FORMAT_PLAYING, false);
        yml.addDefault(ConfigPath.SB_CONFIG_SIDEBAR_LIST_FORMAT_RESTARTING, false);
        yml.addDefault(ConfigPath.SB_CONFIG_SIDEBAR_LIST_REFRESH, 1200);
        yml.addDefault(ConfigPath.SB_CONFIG_SIDEBAR_HEALTH_ENABLE, false);
        ...
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_SHOUT_SHORTCUT, false);
        yml.addDefault(ConfigPath.GENERAL_CONFIG_PLACEHOLDERS_REPLACEMENTS_SERVER_IP, "mc.frawlah.me");
        ...
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_CLEAR_INVENTORY_ON_WIN, false);
        ...
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_LOBBY_POTION_EFFECT_NORMAL_AMPLIFIER, 0);
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_LOBBY_POTION_EFFECT_DONATOR, "SPEED");
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_LOBBY_POTION_EFFECT_DONATOR_AMPLIFIER, 1);
        ...
        // fireball category
        yml.addDefault(ConfigPath.GENERAL_FIREBALL_EXPLOSION_SIZE, 2.5);
        yml.addDefault(ConfigPath.GENERAL_FIREBALL_SPEED_MULTIPLIER, 10);
        yml.addDefault(ConfigPath.GENERAL_FIREBALL_MAKE_FIRE, true);
        ...
        saveLobbyCommandItem("server-selector", "dm open server", false, getForCurrentVersion("COMPASS", "COMPASS", "COMPASS"), 0, 0);
        saveLobbyCommandItem("stats", "bw stats", false, getForCurrentVersion("SKULL_ITEM", "SKULL_ITEM", "PLAYER_HEAD"), 3, 1);
        saveLobbyCommandItem("cosmetics", "bwc menu", false, getForCurrentVersion("EMERALD", "EMERALD", "EMERALD"), 0, 2);
        saveLobbyCommandItem("lobby-selector", "dm open lobbyselector", false, getForCurrentVersion("NETHER_STAR", "NETHER_STAR", "NETHER_STAR"), 0, 8);

        /* Pre Game Command Items */
        savePreGameCommandItem("leave", "bedleave", false, getForCurrentVersion("BED", "BED", "RED_BED"), 0, 8);

        /* Spectator Command Items */
        saveSpectatorCommandItem("teleporter", "bw teleporter", false, getForCurrentVersion("SKULL_ITEM", "SKULL_ITEM", "PLAYER_HEAD"), 3, 0);
        saveSpectatorCommandItem("leave", "bedleave", false, getForCurrentVersion("BED", "BED", "RED_BED"), 0, 8);
        ...
        yml.addDefault(ConfigPath.CENERAL_CONFIGURATION_ALLOWED_COMMANDS, Arrays.asList("shout", "bw", "leave", "map", "wtfmap"));
        ...
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_ENABLE_LEAVE_DELAY, true);
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_LEAVE_DELAY_VALUE, 3);

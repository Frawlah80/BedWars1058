...
public class English extends Language {
    ...
    public English() {
        ...
        yml.addDefault(Messages.FORMATTING_TAB_NAME_LOBBY, "{vPrefix}{player}");
        yml.addDefault(Messages.FORMATTING_TAB_NAME_WAITING, "{vSuffix}{player}");
        yml.addDefault(Messages.FORMATTING_TAB_NAME_PLAYING_PLAYER, "{TeamColor}&l{TeamLetter}&r{TeamColor} {player}");
        yml.addDefault(Messages.FORMATTING_TAB_NAME_PLAYING_SPEC, "&7[SPEC] {player}");
